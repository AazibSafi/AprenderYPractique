...
public class WordBreak_II extends BaseTest {
    ...
    public void solution() {
        ...
        output = Arrays.asList("pine apple pen apple","pineapple pen apple","pine applepen apple");
        Assert.assertTrue(CommonHelper.isEquals(output, wordBreak("pineapplepenapple", wordDict)));
    }
